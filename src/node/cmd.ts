...
export const chunksToBuffer = (chunks: any[]) => chunks.length === 1 ? chunks[0] : Buffer.concat(chunks);
...
export class Cmd {
	...
	constructor(public command: string, public inputs?: CmdValues|null, public options: CmdOptions = {}) {
...
export const cmd = (command: string, values?: CmdValues, options?: CmdOptions): Promise<string|undefined> => {
