...
class VField {
    constructor(options) {
        ...
        el._vField = this;
        const labelEl = (0, setEl_1.setEl)('label', { cls: c + '_label', for: id, ...((0, isString_1.isString)(label) ? { innerHTML: label } : label) });
        const inputEl = (0, setEl_1.setEl)('input', { cls: c + '_input', id, name: id, type, ...input });
...
VField.count = 0;
const vFieldFrom = (o) => (o instanceof VField) ? o : (o instanceof HTMLElement) ? o._vField : new VField(o);
